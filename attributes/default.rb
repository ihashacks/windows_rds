...
# you wish to use.
default[:windows_rds][:certcn] = nil

# If you want to use a different RemoteApp hostname than the node's name (i.e. your nodes are in a farm), set this
default[:windows_rds][:remoteapp_hostname] = nil

# If using the import_certificate recipe, set the two attributes below:
default[:windows_rds][:cert_location] = nil # A local PKCS12 certificate that the node can read
default[:windows_rds][:cert_password] = nil # The password required to decrypt the PKCS12 file
